...
const appProcessedThreshold = 40; // referred is 40, application can not be greater than or equal to this threshold
const getApplicationFromHash = async(req, res, next) => {
    ...
    if(redisResp.found){
        ...
        if(redisValueJSON && redisValueJSON?.applicationId){
            ...
            if(applicationDB.appStatusId >= appProcessedThreshold){
            ...
            log.error(`getApplicationFromHash Could not find and parse redis json value for key: ${redisKey}` + __location);
