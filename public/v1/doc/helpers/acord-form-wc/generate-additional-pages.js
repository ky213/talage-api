...
const styles = require('../../document_style/acord-form-wc/styles.js');
const positions = require('../../document_style/acord-form-wc/positions.js');
...
exports.state_rating_sheets = function(data, ncci_codes){
	...
	for(const[territory, locations]of Object.entries(data)){
		...
		},
		{
			...
			'text': current_rating_sheet.toLocaleString(undefined, {
		...
		},
		{
			...
			'style': styles.rating_sheet_page,
			// eslint-disable-next-line no-undefined
			'text': Object.keys(data).length.toLocaleString(undefined, {
				'minimumIntegerDigits': 2
			})
		});
				...
				rating_sheets = rating_sheets.concat([
					{
						...
						// eslint-disable-next-line no-undefined
						'text': info.loc_num.toLocaleString(undefined, {
							'minimumIntegerDigits': 2
						})
					},
					{
