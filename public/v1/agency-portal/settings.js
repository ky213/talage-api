...
//     //TODO Switch to AgencyLocationBO
//     //  const territoryBO = new TerritoryBO();
//     // Flip agencylocation territories to StateNames
...
//     let locations = null;
//     try{
//         const query = {"agency": agents[0]}
//         const getChildren = true;
//         locations = await  agencyLocationBO.getList(query, getChildren)
//         locations.forEach(function(location){
//             if(location.openTime){
//                 location.open_time = location.openTime;
//             }
//             if(location.closeTime){
//                 location.close_time = location.closeTime;
//             }
...
//         return next(serverHelper.internalError('Well, that wasn’t supposed to happen, but hang on, we’ll get it figured out quickly and be in touch.')); 
//     }
//     log.debug("settings: " + JSON.stringify(locations))
