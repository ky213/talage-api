...
async function getApplications(req, res, next) {
	...
	const expectedParameters = [
		...
		},
		{
			name: 'sort',
			type: 'string',
			values: ['business', 'status', 'agencyName', 'industry', 'location', 'date']
		},
		{
			name: 'sortDescending',
			type: 'boolean'
		...
		},
		{
			...
			type: 'string',
			values: ['', 'bound', 'request_to_bind_referred', 'request_to_bind', 'quoted_referred', 'quoted', 'referred', 'declined', 'error']
		},
		{
			name: 'startDate',
			type: 'string',
