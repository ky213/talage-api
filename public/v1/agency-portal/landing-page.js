...
exports.registerEndpoint = (server, basePath) => {
	server.addPostAuth('Post Landing Page', `${basePath}/landing-page`, createLandingPage, 'pages', 'manage');
	...
	server.addPutAuth('Put Landing Page', `${basePath}/landing-page`, updateLandingPage, 'pages', 'manage');
};