...
const email = requireShared('./services/email.js');
const slack = requireShared('./services/slack.js');
const formatPhone = requireShared('./helpers/formatPhone.js');
const get_questions = requireShared('./helpers/getQuestions.js');
