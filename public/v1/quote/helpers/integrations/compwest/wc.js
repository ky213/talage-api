                ...
                then((result) => {
                    ...
                    switch (status) {
                        ...
                        case 'RESERVED':
                            ...
                            log.info(`${this.insurer.name} ${this.policy.type} Applicatiton Blocked (business already quoted by another agency)`);
                            this.reasons.push(`${status} (blocked) - Another agency has already quotetd this business.`);
                            fulfill(this.return_result('error'));
                            return;
                        default:
                            this.log += '--------======= Unexpected API Response =======--------';
