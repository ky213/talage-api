...
/**
 * Worker's Compensation Integration for Acuity
 *
 * This integration file has answers to the following questions hard-codced in:
			...
			const ACORD = builder.create('ACORD');
				...
				const InsuranceSvcRq = ACORD.ele('InsuranceSvcRq');
					...
					const WorkCompPolicyQuoteInqRq = InsuranceSvcRq.ele('WorkCompPolicyQuoteInqRq');
						...
						WorkCompPolicyQuoteInqRq.ele('TransactionRequestDt', now.format('YYYY-MM-DDTHH:mm:ss'));
						WorkCompPolicyQuoteInqRq.ele('TransactionEffectiveDt', now.format('YYYY-MM-DD'));
						...
						// <InsuredOrPrincipal>
						let InsuredOrPrincipal = WorkCompPolicyQuoteInqRq.ele('InsuredOrPrincipal');
						...
						// <InsuredOrPrincipal>
						InsuredOrPrincipal = WorkCompPolicyQuoteInqRq.ele('InsuredOrPrincipal');
...
*/
						...
						const WorkCompLineBusiness = WorkCompPolicyQuoteInqRq.ele('WorkCompLineBusiness');
							...
							// <WorkCompIndividuals>
							const WorkCompIndividuals = WorkCompLineBusiness.ele('WorkCompIndividuals');
							...
							const WorkCompRateState = WorkCompLineBusiness.ele('WorkCompRateState');
								...
								if(this.app.business.experience_modifier !== 1.00){
								// <CreditOrSurcharge>
