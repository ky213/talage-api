...
module.exports = class HiscoxGL extends Integration {
    ...
    async _insurer_quote() {
                ...
                if (err.httpStatusCode === 422 && err.response) {
                    ...
                    if (
                        ...
                        for (const validationError of validationErrors) {
                            if (Object.prototype.hasOwnProperty.call(validationError, 'DataItem') && Object.prototype.hasOwnProperty.call(validationError, 'Status') && Object.prototype.hasOwnProperty.call(validationError, 'XPath')) {
                        ...
                        for (const errorResponse of errorResponses) {
                            if (errorResponse.Code && errorResponse.Description) {
                                ...
                                log.error(`${this.insurer.name} ${this.policy.type} Integration Error: API returned validation errors, but not as an array as expected.` + __location);
                                this.reasons.push(`API returned an error that could not be parsed. Validation object missing one of the following: DataItem, Status, XPath`);
                            }
                        }
        ...
        if (!Object.prototype.hasOwnProperty.call(result, 'InsuranceSvcRs') || !Object.prototype.hasOwnProperty.call(result.InsuranceSvcRs, 'QuoteRs') || !Array.isArray(result.InsuranceSvcRs.QuoteRs) || result.InsuranceSvcRs.QuoteRs.length !== 1) {
        ...
        if (Object.prototype.hasOwnProperty.call(generalLiabilityQuoteRs, 'RatingResult') && Array.isArray(generalLiabilityQuoteRs.RatingResult) && generalLiabilityQuoteRs.RatingResult.length === 1) {
