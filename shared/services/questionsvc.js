    ...
    questions.forEach(function(question) {
        if (question.parent) {
            if (!question_ids.includes(question.parent)) {
                ...
                log.error(`QuestionSvc.find_missing_questions Potential Bad Insurer Question Mapping questionId ${question.id} missing Parent Id ${question.parent}. Parent Question no Mapped. ` + __location);
            }
        }
    });
