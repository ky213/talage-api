...
async function setupListeners() {
    ...
    if(!await server.create('0.0.0.0', global.settings.QUOTE_PUBLIC_API_PORT || 4000, 'quotesystem/quoting-endpoints', true, isDevelopment, logInfoMessage, logErrorMessage)){
